...
### 0. Описание систем      
  ...
  5. Контроль доступа к информационным ресурсам осуществляется с помощью МСЭ. Использовать два кластера МСЭ. 
     ![Клиентские сети](./Lab_9_Clients.jpg).      
            
### 1. Архитектура сети
Топология: Clos (Leaf-Spine).    
Технологии:    
Underlay: eBGP (As Spine 65000  As Leaf-0 65100, Leaf-1 65101, ... Leaf-9 65009) для обеспечения связности между Loopback-адресами.      
